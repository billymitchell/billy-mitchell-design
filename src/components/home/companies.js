            ...
            <div className="outer-container">
              <div className="inner-width-800">
                ...
                >
                  ...
                  <div className="bg-white padding-25 border-r-7 border-width-4 border-solid border-color-gray-1" >
                    <div className="companies-container grid-container col-5 col-gap-25 small-col-3 small-col-gap-25">
